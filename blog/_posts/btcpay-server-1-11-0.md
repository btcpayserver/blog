We are thrilled to unveil the latest major update of BTCPay Server - **version 1.1.11**!
...
Invoices are the heart of BTCPay Server. Nearly everything revolves around them. However, we understand that there are scenarios where payments are received directly to your wallet or you require additional data beyond what invoices export has to offer. 
...
Going forward, we’re considering creating a more detailed store creating wizard that will offer additional options such as setting up a store branding or email’s SMTP and potentially the wallet setup.. 
...
Our integration wizards worked hard on making our ecommerce plugins compatible with latest and greatest updates:
...
As usual, if you have problems, feedback, feature requests regarding BTCPay Server, feel free to reach out on our community chat. We hope you enjoy what this update has to offer. As always, thank you to our invaluable contributors, who directly participated in making 1.11.0 possible.
