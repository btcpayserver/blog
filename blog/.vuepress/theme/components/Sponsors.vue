    ...
    <div class="supporters">
      ...
      <div class="logos">
        <a href="https://spiral.xyz" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="100" height="100" style="padding:5px;"><use href="#spiral"></use></svg>
          Spiral
        </a>
        <a href="https://www.bailliegifford.com//" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="140" height="100"><use href="#bailliegifford"></use></svg>
          Baillie Gifford
        </a>
        <a href="https://pnxbet.com" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="125" height="100"><use href="#pnxbet"></use></svg>
          PNXBET
        </a>
        <a href="https://www.lunanode.com/" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="100" height="100"><use href="#lunanode"></use></svg>
          LunaNode
        </a>
        <a href="https://walletofsatoshi.com/" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="100" height="100"><use href="#walletofsatoshi"></use></svg>
          Wallet of Satoshi
        </a>
        <a href="https://nomics.com/" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="100" height="100"><use href="#nomics"></use></svg>
          Nomics
        </a>
        <a href="https://coincards.com/" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="130" height="100"><use href="#coincards"></use></svg>
          Coincards
        </a>
        <a href="https://ivpn.net/" target="_blank" rel="noopener noreferrer">
          <svg role="img" width="100" height="100"><use href="#ivpn"></use></svg>
          IVPN
        </a>
      </div>
...
<style scoped>
.theme-default-content.sponsors {
