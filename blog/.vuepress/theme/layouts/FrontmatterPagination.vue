<template>
  <div>
    <div class="theme-default-content">
      ...
      <hr />
      <h2
        v-if="this.$page.path.startsWith('/author/')"
        class="post-list-sub-header"
      >
        Posts by {{ this.$page.frontmatter.title }}
      </h2>
      <h2
        v-if="this.$page.path.startsWith('/category/')"
        class="post-list-sub-header mobile-only"
      >
        {{ this.$page.frontmatter.title | capitalize }}
      </h2>
